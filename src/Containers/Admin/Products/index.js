...
function Products(props) {
    ...
    const showImage = (link) => {
        ...
        return <img src={`${url}/${link}`} width="60" height="60" alt="" />;
    };
    ...
    useEffect(() => {
        ...
        props.fetchProduct();
        props.removeProductInfo();
        props.fetchCategory("product_category");
    }, []);
    return (
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        removeProductInfo: () => {
            dispatch(actions.removeProductInfo());
        },
        fetchCategory: (table) => {
            dispatch(actions.fetchListCategoryReQuest(table));
        },
        deleteProduct: (body) => {
            dispatch(actions.deleteProductReQuest(body));
        },
    };
};
